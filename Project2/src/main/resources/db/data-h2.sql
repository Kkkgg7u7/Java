...
SELECT 1, 'admin', '$2y$10$Lg.4Cgh.KmvC0c8oM.Q6X.5Su.JqgmQYt9nGZeiy6t.xlF3odAQ5q', '管理员'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = 1);

INSERT INTO users (id, username, password, nickname)
SELECT 2, 'test', '$2y$10$61taXkQZrCyYJ5u2Z7JmQO8DhDPAydJe9ZBYsUN/e/9U7rczX/xRK', '测试用户'
